...
function Navbar() {
  ...
  return (
    <nav id="navbar" className="relative flex items-center justify-between my-5 mx-8 lg:mx-[170px]">
      <div className="nerko-one-regular text-3xl font-semibold text-white lg:ml-[-8.5rem]">VK-Dev</div>
  ...
  <li className="cursor-pointer py-2 lg:py-0 border-b lg:border-b-0 border-white">
    ...
    >
      ...
      <div className="hidden lg:block mr-[-8rem] text-xl px-5 py-2 rounded-full bg-blue-700 text-white cursor-pointer transition-transform duration-500 hover:scale-105">
